...
comment on column lookup_values.is_hidden IS 'Flag indicating whether the lookup value should be excluded from the lookup.';
...
comment on column lookup_values.description IS 'Description of the lookup value.';
