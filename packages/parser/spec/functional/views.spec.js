...
import { extractViews, extractViewName, extractViewSchema, extractIsReplace,
  extractViewColumns, extractViewDependencies, extractViewDefinition } from '../../src/extractors/views.js';
...
describe('View Extractor - Functional API', () => {
  ...
  describe('Component extraction utilities', () => {
    it('should extract view names correctly', () => {
      ...
      expect(extractViewName({ view: { view: 'complex_view', schema: 'app' } })).toBe('complex_view');
    });
